        ...
        {!open && (
          <div className="flex flex-col justify-between h-[140px]">
            <div className="flex justify-between items-start">
              <span className="text-lg font-medium text-gray-450 leading-tight">{title}</span>
              <div onClick={(e) => {
                e.stopPropagation();
                setShowDetails(true);
              }}
                className="border border-gray-100 rounded-lg w-[28px] h-[28px] flex items-center justify-center shrink-0">
                <Image
                  src="/images/icons/info-icon.svg"
                  alt="info"
                  width={4}
                  height={14}
                  className="text-[#9B9B9B] transition-colors cursor-pointer"
