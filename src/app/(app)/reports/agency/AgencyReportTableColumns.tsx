...
import { PatientReportDaysDot, PatientReportStatusDot } from "@/data/patientReportStaticData";
import { AgencyReportRow, agencyRowToOrderRow } from "@/data/agencyReportStaticData";
import { useMemo } from "react";

function statusDotClass(dot: PatientReportStatusDot) {
    switch (dot) {
        case "green":
...
export function useAgencyReportTableColumns(): DataTableColumn<AgencyReportRow>[] {
    return useMemo(
        () => [
            {
                key: "date",
            ...
            },
            {
                ...
                className: "min-w-0",
                cell: (row) => (
                    <div className="flex flex-col items-start gap-0.5 leading-tight overflow-hidden">
            ...
            },
            {
                ...
                className: "min-w-0",
                cell: (row) => {
                    const orderRow = agencyRowToOrderRow(row);
                    return (
