...
import { HospiceReportRow, HospiceStatusLabel } from "@/data/hospiceReportStaticData";
import { DataTableColumn } from "@/components/common/DataTable";
import { useMemo } from "react";
import { HiChevronDown, HiChevronUp } from "react-icons/hi";


function latencyStatusSquareClass(label: HospiceStatusLabel) {
  switch (label) {
    case "Fastest":
      return "bg-[#22c55e]";
    case "Fast":
...
export function useHospiceTableColumns(): DataTableColumn<HospiceReportRow>[] {
  return useMemo(
    () => [
      {
        key: "agencyId",
