...
import { PhysicianReportRow, physicianRowToOrderRow } from "@/data/physicianReportStaticData";
...
export function usePhysicianReportTableColumns(): DataTableColumn<PhysicianReportRow>[] {
  return useMemo(
    () => [
      {
        key: "date",
      ...
      },
      {
        ...
        className: "min-w-0",
        cell: (row) => {
          const orderRow = physicianRowToOrderRow(row);
          return (
