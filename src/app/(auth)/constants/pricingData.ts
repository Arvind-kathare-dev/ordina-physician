...
export const plans: Plan[] = [
  {
    ...
    name: "TRIAL",
    badge: "1 Month",
    badgeColor: "bg-grayCustom-320 text-ordina-300",
  ...
  },
  {
    ...
    orderLimitColor: "bg-grayCustom-100 text-ordina-300",
    features: [
      { text: "All Ordina platform features included" },
      { text: "Agency and physician workflows enabled" },
      { text: "Order processing, monitoring, and reporting" },
  ...
  },
  {
    ...
    name: "SCALE",
    badge: "Up to 10,000",
    badgeColor: "bg-purple-220 text-purple-560",
    description:
  ...
  },
  {
    ...
    name: "ENTERPRISE",
    badge: "Contact Us",
    badgeColor: "bg-green-150 text-green-420",
    description:
