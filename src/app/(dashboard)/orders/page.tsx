...
import { orderColumns } from "@/features/orders/components/OrderColumns";
...
export default function OrdersTable() {
    ...
    <div className="min-h-screen">
      <div className="w-full mx-auto">
        ...
        <div className="flex items-center gap-2 mb-4 flex-wrap">
          ...
          <h1 className="text-2xl font-semibold text-grayCustom-600 mr-auto">
            All Orders of ABC Pvt Ltd
          </h1>
  ...
  <div className="min-w-[1200px] mb-4">
           <Table data={orders} columns={orderColumns} colNum={9} />
